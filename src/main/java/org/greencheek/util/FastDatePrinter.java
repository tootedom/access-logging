...
/**
 * A modification of the origin FastDatePrinter from commons lang 3 (https://github.com/apache/commons-lang)
 * but modified to no longer be Thread safe, (it contains a final Calendar instance),
 * The class is modified to remove StringBuffer and replace with StringBuilder
 */

/**
 * <p>FastDatePrinter is a fast and <b>NOT</b> thread-safe version of
...
public class FastDatePrinter implements Serializable {
    public static final char[][] unpaddedTwoDigitNumbers = new char[100][2];
    static {
        unpaddedTwoDigitNumbers[0] = new char[] { '0','0'};
        unpaddedTwoDigitNumbers[1] = new char[] { '0','1'};
        unpaddedTwoDigitNumbers[2] = new char[] { '0','2'};
        unpaddedTwoDigitNumbers[3] = new char[] { '0','3'};
        unpaddedTwoDigitNumbers[4] = new char[] { '0','4'};
        unpaddedTwoDigitNumbers[5] = new char[] { '0','5'};
        unpaddedTwoDigitNumbers[6] = new char[] { '0','6'};
        unpaddedTwoDigitNumbers[7] = new char[] { '0','7'};
        unpaddedTwoDigitNumbers[8] = new char[] { '0','8'};
        unpaddedTwoDigitNumbers[9] = new char[] { '0','9'};

        for(int i=10;i<100;i++) {
            unpaddedTwoDigitNumbers[i] = Integer.toString(i).toCharArray();
        }
    }
    ...
    private static class UnpaddedNumberField implements NumberRule {
        ...
        public final void appendTo(final StringBuilder buffer, final int value) {
            if (value < 10) {
                ...
                buffer.append(unpaddedTwoDigitNumbers[value][0]);
                buffer.append(unpaddedTwoDigitNumbers[value][1]);
//                buffer.append((char)(value / 10 + '0'));
//                buffer.append((char)(value % 10 + '0'));
            } else {
...
//            buffer.append((char)(value % 10 + '0'));
    ...
    private static class TimeZoneNumberRule implements Rule {
        ...
        public void appendTo(final StringBuilder buffer, final Calendar calendar) {
            ...
            buffer.append(unpaddedTwoDigitNumbers[hours][0]);
            buffer.append(unpaddedTwoDigitNumbers[hours][1]);
...
//            buffer.append((char)(hours % 10 + '0'));
            ...
            buffer.append(unpaddedTwoDigitNumbers[minutes][0]);
            buffer.append(unpaddedTwoDigitNumbers[minutes][1]);
...
//            buffer.append((char)(minutes % 10 + '0'));
    ...
    public static void main(String[] args) {
        FastDatePrinter p = new FastDatePrinter("[dd/MMM/yyyy:HH:mm:ss Z]", TimeZone.getDefault(),Locale.ENGLISH);
        Calendar c = new GregorianCalendar();
        c.set(2010,0,10,9,4,0);

        System.out.println(p.format(c.getTime().getTime()));
    }
}